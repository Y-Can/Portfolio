import tabJoursEnOrdre from './JS/Utilitaire/gestionTemps.js';

// console.log("DEPUIS MAIN JS:" + tabJoursEnOrdre);

const CLEFAPI = 'cd41d83c184baa4407bac29480fcce10';
let resultatsAPI;
...
function AppelAPI(long, lat) {
    ...
    fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${long}&exclude=minute&units=metric&lang=fr&appid=${CLEFAPI}`)
    .then((reponse) => {
        return reponse.json();
    })
    .then((data) => {
